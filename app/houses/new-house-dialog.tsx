...
export function NewHouseDialog() {
      ...
      <DialogContent>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Adicione uma nova casa de apostas ao sistema.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="url">URL da Casa Oficial</Label>
              <Input
                id="url"
                type="url"
                value={url}
                onChange={(e) => setUrl(e.target.value)}
                placeholder="https://www.estrelabet.bet.br"
                required
              />
            </div>
